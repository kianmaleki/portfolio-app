    ...
    <Container className="flex-col items-center justify-center">
      ...
      >
        <ToggleGroupItem
          ...
          className="bg-[#171F26] text-[#A3ABB2] p-8 text-sm sm:text-base hover:bg-[#171F26] hover:cursor-pointer transition-colors border-none data-[state=on]:rounded-2xl data-[state=on]:bg-[#0C151D] data-[state=on]:text-white"
        >
          Portfolio
        </ToggleGroupItem>
        <ToggleGroupItem
